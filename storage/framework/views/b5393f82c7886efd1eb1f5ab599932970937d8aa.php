...
<script type="text/javascript">
        $(function() {
            $("#province").on('change', function() {
                axios.post('<?php echo e(route('profilPerusahaan.store')); ?>', {id: $(this).val()})
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\INDOGETJOB\resources\views/profilPerusahaan.blade.php ENDPATH**/ ?>